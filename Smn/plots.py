...
from Smn.utils import bar_plot, group_elasticities, plot_nformat, resample_nlog, scatter_plot
...
def main(
    ...
    brand_w = scatter_plot(
        brand_elasticities[brand_elasticities.Sales > 1000],
        "Average_Price",
        "Elasticity",
        "Revenue",
        "Brand",
    ...
    brand_w.savefig(
        output_path / "elasticity_weekly_brand_scatter.png", dpi=300, bbox_inches="tight"
    )
    plt.close()
    ...
    brand_d = scatter_plot(
        brand_elasticities_d[brand_elasticities_d.Sales > 1000],
        "Average_Price",
        "Elasticity",
        "Revenue",
        "Brand",
    ...
    brand_d.savefig(
        output_path / "elasticity_daily_brand_scatter.png", dpi=300, bbox_inches="tight"
    )
    plt.close()
    ...
    price_cat_scatter = scatter_plot(
        price_cat_groups[price_cat_groups.Sales > 1000],
        "Average_Price",
        "Elasticity",
        "Revenue",
        "Price Category",
    ...
    price_cat_scatter.savefig(
        output_path / "elasticity_weekly_price_cat_scatter.png", dpi=300, bbox_inches="tight"
    )
    plt.close()
    ...
    bar_plot(
        typeprice_cat_groups, "Elasticity", "type_price", "Type/Price Combinations", "Revenue", 10
    )
    ...
    typeprice_scatter = scatter_plot(
        typeprice_cat_groups[typeprice_cat_groups.Sales > 1000],
        "Average_Price",
        "Elasticity",
        "Revenue",
        "Type/Price",
    ...
    typeprice_scatter.savefig(
        output_path / "elasticity_weekly_type_price_scatter.png", dpi=300, bbox_inches="tight"
    )
    plt.close()
